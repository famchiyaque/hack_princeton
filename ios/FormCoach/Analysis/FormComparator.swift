...
struct FormComparator {
    ...
    static let reference: [ExerciseType: [String: ReferenceFrame]] = [
        .pushup: [
            "bottom": ReferenceFrame(elbowAngle: .init(min: 70,  max: 100), kneeAngle: nil,
                                     hipAngle:   .init(min: 160, max: 180), spineAngle: .init(min: 160, max: 180)),
            "top":    ReferenceFrame(elbowAngle: .init(min: 155, max: 180), kneeAngle: nil,
                                     hipAngle:   .init(min: 160, max: 180), spineAngle: .init(min: 160, max: 180)),
        ],
        .squat: [
            "bottom": ReferenceFrame(elbowAngle: nil, kneeAngle: .init(min: 60,  max: 100),
                                     hipAngle:  .init(min: 60,  max: 100), spineAngle: .init(min: 150, max: 180)),
            "top":    ReferenceFrame(elbowAngle: nil, kneeAngle: .init(min: 155, max: 180),
                                     hipAngle:  .init(min: 155, max: 180), spineAngle: .init(min: 150, max: 180)),
        ],
        .plank: [
            "hold":   ReferenceFrame(elbowAngle: .init(min: 85,  max: 95),  kneeAngle: .init(min: 160, max: 180),
                                     hipAngle:   .init(min: 160, max: 180), spineAngle: .init(min: 160, max: 180)),
        ],
        .lunge: [
            "bottom": ReferenceFrame(elbowAngle: nil, kneeAngle: .init(min: 85,  max: 100),
                                     hipAngle:  .init(min: 85,  max: 100), spineAngle: .init(min: 150, max: 180)),
            "top":    ReferenceFrame(elbowAngle: nil, kneeAngle: .init(min: 155, max: 180),
                                     hipAngle:  .init(min: 155, max: 180), spineAngle: .init(min: 150, max: 180)),
        ],
    ]
    ...
    static let weights: [ExerciseType: [String: Double]] = [
        .pushup: ["elbowAngle": 0.40, "hipAngle": 0.30, "spineAngle": 0.20],
        .squat:  ["kneeAngle": 0.40, "hipAngle": 0.25, "spineAngle": 0.25],
        .plank:  ["hipAngle": 0.40, "spineAngle": 0.30, "elbowAngle": 0.20, "kneeAngle": 0.10],
        .lunge:  ["kneeAngle": 0.40, "hipAngle": 0.30, "spineAngle": 0.20],
    ]
